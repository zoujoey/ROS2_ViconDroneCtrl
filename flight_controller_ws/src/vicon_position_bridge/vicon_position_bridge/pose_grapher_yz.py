...
class PositionGraph(Node):
    ...
    def update_graph(self):
        self.ax.plot(self.y_positions, self.z_positions, color='blue')

        # Set labels and title
        plt.title('VICON Positions Y vs VICON Positions Z')
    ...
    def save_plot(self, event):
        self.ax.figure.savefig('Vicon_yz_position_trajectory.png')
        print("Plot saved as 'Vicon_yz_position_trajectory.png'")
