"""
ROS2 Node for sending trajectory setpoints for L-shaped trajectory (simply run the node when placing drone at starting point, sp)
...
class OffboardControl(Node):
    ...
    def __init__(self):
        ...
        self.setpoint_targets = [(0.4,-2.03,-0.5,-1.5), 
                                 (0.6,-2.03,-0.5,-1.5),
                                 (0.4,-2.03,-0.5,-1.5),
                                 (0.4,-2.03,-0.26,-1.5)]        
